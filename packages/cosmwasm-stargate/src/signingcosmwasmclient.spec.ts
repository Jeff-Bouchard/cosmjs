...
import { setupWasmExtension, UploadMeta, WasmExtension } from "@cosmjs/cosmwasm";
...
//       const client = new SigningCosmWasmClient(wasmd.endpoint, alice.address0, wallet, gasPrice);
...
//         send: 160000,
//       };
//       const client = new SigningCosmWasmClient(wasmd.endpoint, alice.address0, wallet, undefined, gasLimits);
//       const openedClient = (client as unknown) as PrivateSigningCosmWasmClient;
//       expect(openedClient.fees).toEqual({
//         upload: {
//           amount: [
...
//         send: 160000,
//       };
//       const client = new SigningCosmWasmClient(wasmd.endpoint, alice.address0, wallet, gasPrice, gasLimits);
//       const openedClient = (client as unknown) as PrivateSigningCosmWasmClient;
//       expect(openedClient.fees).toEqual({
//         upload: {
//           amount: [
...
//       const lcdClient = makeWasmClient(wasmd.endpoint);
