...
import { AuthExtension, QueryClient, setupAuthExtension } from "@cosmjs/stargate";
...
type WasmClient = QueryClient & AuthExtension & WasmExtension;

function makeWasmClient(tmClient: TendermintClient): WasmClient {
  return QueryClient.withExtensions(tmClient, setupAuthExtension, setupWasmExtension);
}
